...
type_choice_keyboard = [["📋 С вариантами", "✍️ Свободный ввод"], ["🔙 Отмена"]]
...
async def handle_answer(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if user_id in ADMIN_ID:
        ...
        if action == "add_question_text":
            ...
            await update.message.reply_text("📌 Выберите тип вопроса:", reply_markup=ReplyKeyboardMarkup(type_choice_keyboard, resize_keyboard=True))
            return

        elif action == "add_question_type":
            if text == "📋 С вариантами":
                context.user_data["new_q_type"] = "choice"
                ...
                await update.message.reply_text("⚠️ Пожалуйста, выберите тип с кнопки.")
                return
