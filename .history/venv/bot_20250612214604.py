...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text("🌐 Выберите язык / Tilni tanlang / Choose language:", reply_markup=ReplyKeyboardMarkup(keyboard, resize_keyboard=True))
    # Выбор языка
    if "lang" not in context.user_data and text in ["Русский 🇷🇺", "O‘zbek 🇺🇿", "English 🇬🇧"]:
        lang_map = {
            "Русский 🇷🇺": "ru",
            "O‘zbek 🇺🇿": "uz",
            "English 🇬🇧": "en"
        }
        context.user_data["lang"] = lang_map[text]
